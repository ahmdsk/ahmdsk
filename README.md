...
### Language And Tools
![My Skills](https://skills.thijs.gg/icons?i=php,laravel,javascript,typescript,vue,react,expressjs,nodejs,vite,bootstrap,tailwindcss,mysql,postgresql,firebase,mongodb,go,dart,flutter,androidstudio,vscode&theme=light)
