...
### Language And Tools
![My Skills](https://skills.thijs.gg/icons?i=php,laravel,javascript,typescript,vue,react,svelte,expressjs,nodejs,vite,bootstrap,tailwindcss,mysql,postgresql,firebase,go,dart,flutter,androidstudio,vscode&theme=light)
