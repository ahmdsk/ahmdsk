...
### Language And Tools
![My Skills](https://skills.thijs.gg/icons?i=php,laravel,javascript,typescript,vue,react,expressjs,nodejs,vite,bootstrap,tailwindcss,scss,mysql,postgresql,firebase,mongodb,vscode,git,kotlin,dart,flutter&theme=light)
